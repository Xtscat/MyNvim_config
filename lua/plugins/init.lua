...
local ui = {
    ...
    -- { "dstein64/nvim-scrollview",            config = with_config_and_keys("configs.ui", "nvim_scrollview_config", nil) },
    {
        ...
        config = with_config_and_keys("configs.ui", "nvim_scrollbar_config", nil),
        opts = {},
    },
    -- 缩进线
    {
    ...
    { "lewis6991/gitsigns.nvim", config = with_config_and_keys("configs.ui", "gitsigns_config", nil) },
    {
        ...
        config = with_config_and_keys("configs.ui", "git_conflict_config", "git_conflict_keymaps"),
    },
}
    ...
    latex = {
        {
            "lervag/vimtex",
            ft = { "tex", "plaintex", "bib" },
            config = with_config_and_keys("configs.tex", "tex_config", nil),
        },
    },
