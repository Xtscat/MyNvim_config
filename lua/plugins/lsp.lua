return {
    ...
    config = function()
        ...
        -- local capabilities_with_blink = require('blink.cmp').get_lsp_capabilities(default_capabilities)
        -- 获取 Neovim 默认的 LSP capabilities
        local base_capabilities = vim.lsp.protocol.make_client_capabilities()
        -- 将默认 capabilities 传递给 blink.cmp，让它添加或修改所需的部分
